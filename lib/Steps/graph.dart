...
class Graph extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center( // Center the container
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Colors.blueAccent, width: 2), // Border
          borderRadius: BorderRadius.circular(12), // Rounded corners
        ),
        height: 300, // Set a fixed height for the container
        width: double.infinity, // Set a fixed width for the container
        child: const SizedBox(
          width: double.infinity,
          child: GraphArea(), // The actual graph area
        ),
      ),
    );
  }
...
class GraphPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw a dot at the fifth data point
    if (offsets.length > 4) {
